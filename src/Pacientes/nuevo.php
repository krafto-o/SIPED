...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['buscar_tutor'])) {
    $terminoTutor = trim($_POST['termino_tutor'] ?? '');
...
<body>
    ...
    <div class="modal-overlay" id="modalBuscarTutor">
        <div class="modal">
            ...
            <div class="modal-body">
                <form method="POST" action="/Pacientes/nuevo">
                    <div class="search-bar">
                        <input type="text" name="termino_tutor" class="form-input" placeholder="Buscar por nombre o telefono...">
                        <button type="submit" name="buscar_tutor" class="btn btn-primary">Buscar</button>
                    </div>
                </form>

                <?php if (!empty($resultadosBusquedaTutores)): ?>
                    <div class="tutor-list mt-md">
                        <?php foreach ($resultadosBusquedaTutores as $tutor): ?>
                            <div class="tutor-item">
                                <div class="tutor-item-info">
                                    ...
                                    <span><?= htmlspecialchars($tutor['telefono']) ?> - <?= htmlspecialchars($tutor['correo'] ?? 'Sin correo') ?></span>
                                </div>
                                <button type="button" class="btn btn-primary btn-sm btnSeleccionarTutor"
                                        data-id="<?= (int) $tutor['id_tutor'] ?>"
                                        data-nombre="<?= htmlspecialchars($tutor['nombre'] . ' ' . $tutor['apellidos']) ?>">
                                    Seleccionar
                                </button>
                            </div>
                        <?php endforeach; ?>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            document.querySelectorAll('.btnSeleccionarTutor').forEach(btn => {
